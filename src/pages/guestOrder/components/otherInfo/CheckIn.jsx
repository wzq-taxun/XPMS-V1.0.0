...
import { getRoomNo, getVCRoomNo } from '@/services/checkIn';
import Constants from '@/constans';
import moment from 'moment';
import { checkIn } from '@/services/order';
...
const CheckIn = props => {
  ...
  const [roomId, setRoomId] = useState(props.room_no_id);
  ...
  useEffect(() => {
    const { room_type_id, checkout_time } = props;
    const checkin_time = moment().format('YYYY-MM-DD HH:mm:ss');
...
export default connect(({ global }) => ({ loading: global.loading }))(CheckIn);
