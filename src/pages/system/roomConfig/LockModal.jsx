...
import { addLock, updateLock } from '@/services/rooms';
  ...
  const handleSubmit = () => {
    props.form.validateFields((err, fieldsValue) => {
      if (err == null) {
        ...
        if (props.isAdd) {
          setLoading(true);
          addLock([{ ...fieldsValue, hotel_group_id, hotel_id, create_user, modify_user }]).then(
            rsp => {
              setLoading(false);
          ...
          setLoading(true);
          updateLock([{ ...fieldsValue, id: props.formValues.id, modify_user }]).then(rsp => {
            setLoading(false);
            if (rsp && rsp.code == Constants.SUCCESS) {
