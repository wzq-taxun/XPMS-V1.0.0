...
const CodeMaintain = props => {
  ...
  const handleDeleteRow = record => {
    ...
    updateMaintain([{ id: record.id, valid: '0', modify_user: currentUser.id }]).then(rsp => {
