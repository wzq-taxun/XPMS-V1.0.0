...
import { getCoupons, addMemberUpRightCoupons, updateMemberUpRightCoupons } from '@/services/member';
  ...
  const handleSubmit = () => {
    props.form.validateFields((err, fieldsValue) => {
      if (err == null) {
        ...
        setLoading(true);
        if (props.isAdd) {
          addMemberUpRightCoupons({
            ...fieldsValue,
            up_rights_id: props.upRightsId,
            hotel_group_id,
            create_user,
