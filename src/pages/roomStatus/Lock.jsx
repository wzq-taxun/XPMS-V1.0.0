...
import { updateRoomStatus, getLockReason, lockRoom } from '@/services/rooms';
  ...
  handleSubmit = e => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        const param = [
          {
            lock_code_id: values.lock_code_id,
            lock_code: reasonObj[values.lock_code_id].code,
            description: reasonObj[values.lock_code_id].description,
    ...
    return (
      ...
      >
        <Form {...formItemLayout} className={styles.modalForm}>
          ...
          <Form.Item label="原因">
            {getFieldDecorator('lock_code_id', {
