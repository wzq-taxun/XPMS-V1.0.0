import { Chart, Coord, Geom, Tooltip, Label } from 'bizcharts';
              ...
              >
                {!!geomLabel && (
                  <Label
                    ...
                    //   percent = (percent * 100).toFixed(2) + '%';
                    //   return (
                    //     '<p style="margin:0;padding:0;font-size:14px;font-style:normal;font-weight:normal;">' +
                    //     point.x +
                    //     '<br/> ' +
                    //     percent +
                    //     '</p>'
              ...
              <div className={styles.total}>
                {subTitle && (
                  <h4
                    ...
                    style={!total ? { fontSize: '24px', marginBottom: '0' } : null}
                  >
                    {subTitle}
                  </h4>
                )}
